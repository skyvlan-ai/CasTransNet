...
def ACDC_224():
    ...
    config.hyper_parameter.batch_size = 4
    config.hyper_parameter.base_learning_rate = 1e-4

    # config.hyper_parameter.final_learning_rate = 1e-4
    config.hyper_parameter.model_size = 'Base'
    config.hyper_parameter.blocks_num = [2, 2, 6, 2]
    # 2 2 6 2
    config.hyper_parameter.val_eval_criterion_alpha = 0.9
    config.hyper_parameter.epochs_num = 150
    config.hyper_parameter.convolution_stem_down = 4
    config.hyper_parameter.channelAttention_reduce = [4, 8, 16, 16]
    # config.hyper_parameter.num_heads = [4, 8, 16, 32]
...
def Synapse_224():
    ...
    config.hyper_parameter.epochs_num = 80
    config.hyper_parameter.convolution_stem_down = 4
    config.hyper_parameter.channelAttention_reduce = [4, 8, 16, 16]
