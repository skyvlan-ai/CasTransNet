...
def main():
    ...
    parser = argparse.ArgumentParser(description="The MSD provides data as 4D Niftis with the modality being the first"
                                                 ...
                                                 "expects")
    parser.add_argument("-i", default='/home/q/CPCANet/DATASET/nnUNet_raw/nnUNet_raw_data/Task02_Synapse', help="Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from the MSD "
