...
def main():
    ...
    parser.add_argument("-i", '--input_folder', default="", help="Must contain all modalities for each patient in the correct"
                                                     " order (same as training). Files must be named "
                                                     "CASENAME_XXXX.nii.gz where XXXX is the modality "
                                                     "identifier (0000, 0001, etc)", required=False)
    parser.add_argument('-o', "--output_folder", default="", required=False, help="folder for saving predictions")
    parser.add_argument('-t', '--task_name', help='task name or task ID, required.',
                        default="001", required=False)
    ...
    parser.add_argument('-tr', '--trainer_class_name',
                        help='Name of the nnUNetTrainer used for 2D U-Net, full resolution 3D U-Net and low resolution '
                             ...
                             % default_trainer,
                        required=False,
                        default="nnUNetTrainerV2_CASTransv1_acdc")
