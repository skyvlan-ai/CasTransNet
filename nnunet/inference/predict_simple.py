...
def main():
    ...
    parser.add_argument("-i", '--input_folder', default="/home/q/CPCANet/DATASET/nnUNet_raw/nnUNet_raw_data/Task002_Synapse/imagesTs", help="Must contain all modalities for each patient in the correct"
                                                     " order (same as training). Files must be named "
                                                     "CASENAME_XXXX.nii.gz where XXXX is the modality "
                                                     "identifier (0000, 0001, etc)", required=False)
    parser.add_argument('-o', "--output_folder", default="/home/q/CPCANet/inferTs/CASTRansv1_synapse_0.5step", required=False, help="folder for saving predictions")
    parser.add_argument('-t', '--task_name', help='task name or task ID, required.',
                        default="002", required=False)
    ...
    parser.add_argument('-tr', '--trainer_class_name',
                        help='Name of the nnUNetTrainer used for 2D U-Net, full resolution 3D U-Net and low resolution '
                             ...
                             % default_trainer,
                        required=False,
                        default="nnUNetTrainerV2_CASTransv1_synapse")
    ...
    parser.add_argument('-m', '--model', default="2d", help="2d, 3d_lowres, 3d_fullres or 3d_cascade_fullres. Default: 3d_fullres", required=False)
    ...
    parser.add_argument('-z', '--save_npz', required=False, action='store_true', default=False,
    ...
    parser.add_argument("--disable_tta", required=False, default=True, action="store_true",
