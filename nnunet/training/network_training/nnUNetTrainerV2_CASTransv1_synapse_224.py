...
class nnUNetTrainerV2_CASTransv1_synapse_224(nnUNetTrainer):
    """
    ...
    def initialize_optimizer_and_scheduler(self):
        ...
        tmp = 2211/(self.batch_size) * self.max_num_epochs
        self.scheduler = CosineAnnealingLR(self.optimizer, T_max=tmp, eta_min=1e-5)
