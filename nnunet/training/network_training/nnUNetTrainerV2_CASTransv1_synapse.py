...
class nnUNetTrainerV2_CASTransv1_synapse(nnUNetTrainer):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        if self.model_size == 'Base':
            ...
            if self.pretrain:
                self.pre_trained_weight = torch.load("/home/q/CPCANet/DATASET/nnUNet_trained_models/nnUNet/2d/Task002_Synapse/nnUNetTrainerV2_CASTransv1_synapse__nnUNetPlansv2.1/fold_0/MA_8509.model",
                                                     map_location='cpu')
