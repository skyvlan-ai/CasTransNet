...
class nnUNetTrainer(NetworkTrainer):
    ...
    def run_online_evaluation(self, output, target):
        with torch.no_grad():
            ...
            for c in range(1, num_classes):
                ...
                # hd95 = hausdorff_distance_95(test=(output_seg == c), reference=(target==c), voxel_spacing=None,
                #                              connectivity=1)
            ...
            # self.online_eval_hd95.append(hd95_scores)
    ...
    def finish_online_evaluation(self):
        ...
        global_dc_per_class = [i for i in [2 * i / (2 * i + j + k) for i, j, k in
                               ...
                               if not np.isnan(i)]
        hd95_scores = [item for sublist in self.online_eval_hd95 for item in sublist]
