...
class NetworkTrainer(object):
    ...
    def load_best_checkpoint(self, train=True):
        ...
        if isfile(join(self.output_folder, "MA_92.25.model")):
            self.load_checkpoint(join(self.output_folder, "MA_92.25.model"), train=train)
        else:
    ...
    def find_lr(self, num_iters=100, init_value=1e-6, final_value=10., beta=0.98):
        """
